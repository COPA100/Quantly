...
This is going to take a while to learn and make so I will make the backend first and once that's done I will create the frontend. Also, I am using pybind to combine the C++ and python together. C++ makes more sense to utilize for more complex calculations and when scaled to many users.
